...
class MessagesController(val messagingTemplate: SimpMessageSendingOperations) {
    ...
    //join user chat /queue/chat/messages/chat /topic/chat/messages/chat
    @MessageMapping("/queue/chat/messages/**")
    fun chat(msg: Message<String>, principal: Principal){
    ...
    fun chatSubscribe(msg: Message<Any?>, user: Principal) {
